...
public class GameController : MonoBehaviour {
    ...
    public SimpleObjectPool answerButtonObjectPoll;
    ...
    private void ShowQuestion() 
    {
        ...
        {
            GameObject answerButtonGameObject = answerButtonObjectPoll.GetObject();

            answerButtonGameObject.GetComponent<Transform>().SetParent(answerButtonParent);
    ...
    private void RemoveAnswerButtons()
    {
        ...
        {
            answerButtonObjectPoll.ReturnObject(answerButtonGameObjects[0]);
